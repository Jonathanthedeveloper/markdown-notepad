...
export function SearchAndReplaceToolbar() {
	...
	return (
		<Popover open={open}>
			<Tooltip>
				<TooltipTrigger render={<PopoverTrigger disabled={!editor} render={<Button variant="ghost" size="sm" onClick={() => {
					setOpen(!open);
				}} className={cn("h-8 w-max px-3 font-normal")} />} />}><Repeat className="mr-2 h-4 w-4" /><p>Search & Replace</p></TooltipTrigger>
				<TooltipContent>
