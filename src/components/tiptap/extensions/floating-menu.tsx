...
const groups: CommandGroupType[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: "Add a collapsible details block",
        icon: ListCollapse,
        keywords: "collapsible details accordion toggle",
      ...
      },
      {
        ...
        command: (editor) => editor.chain().focus().insertInlineMath({ latex: "" }).run(),
      },
      {
        title: "Emoji",
        description: "Insert an emoji",
        icon: SmilePlus,
        keywords: "emoji smile face emotion",
...
export function TipTapFloatingMenu({ editor }: { editor: Editor }) {
  ...
  return (
    ...
    >
      <Command role="listbox" ref={commandRef} className="z-50 w-[min(288px,calc(100vw-32px))] overflow-hidden rounded-lg border bg-popover shadow-lg">
